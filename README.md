...
At this stage, the project assumes that the user is already authenticated / logged in. The user authentication flow is yet to be implemented.
...
Launches Cypress e2e test runner and executes all cypress tesets.
